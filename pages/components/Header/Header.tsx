...
export default function Header({ setLocation, modalSet }: Props) {
    ...
    <div className={scrollY ? styles.header_white : styles.header_trans}>
      <div className={styles.header_body}>
        <div className={scrollY ? styles.logo_blue : styles.logo_white}>
          <img
            src={
              scrollY ? "/img/logo/logo_blue.png" : "/img/logo/logo_white.png"
            }
        ...
        <div className={styles.herder_right}>
          ...
          <img
            ...
            src={
              scrollY ? "/img/icon/menu_blue.png" : "/img/icon/menu_white.svg"
            }
